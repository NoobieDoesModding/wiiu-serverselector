...
note 1: it crashes when loading already loaded plugin

note 2: if anything crashes, try deleting any "inkay-pretendo.wms" and "inkay-pretendo.wps" files, or whatever they may be called for you.
